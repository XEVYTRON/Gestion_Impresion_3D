...
# --- ESTILOS CSS UNIFICADOS (DISEÑO PREMIUM PARA MÓVIL) ---
st.markdown("""
    <style>
        ...
        /* FORMATO DE TARJETA UNIFICADO */
        .card-container {
            background-color: #fff; 
            border-radius: 10px; 
            padding: 15px;
            border: 1px solid #e0e0e0; 
            border-left: 6px solid #6f42c1; /* Color corporativo Xevytron */
            box-shadow: 0 2px 5px rgba(0,0,0,0.05); 
            margin-bottom: 5px;
        }
        
        /* EL CAMBIO QUE HAS PEDIDO: Cliente más grande y en negrita */
        .info-superior { 
            font-size: 21px; 
            font-weight: 800; 
            color: #111; 
        ...
        /* La pieza ahora es un poco más pequeña que el cliente */
        .info-principal { 
            font-size: 16px; 
            font-weight: 500; 
            color: #555; 
...
# 5. VISTA: TRABAJOS (Nombres invertidos y jerarquizados)
