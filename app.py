...
st.markdown("""
    <style>
        ...
        /* ESTILOS ESPECÍFICOS PARA TRABAJOS (Cliente Grande y Negrita) */
        ...
        /* ESTILOS ESPECÍFICOS PARA FACTURAS (Como estaba antes) */
...
# 5. VISTA: TRABAJOS (Diseño con Cliente Grande)
...
# 7. VISTA: FACTURAS (Diseño Clásico Revertido)
