...
# --- ESTILOS CSS (DISEÑO PREMIUM Y ARREGLO DE COLUMNAS MÓVIL) ---
st.markdown("""
    <style>
        ...
        /* ARREGLO PARA COLUMNAS EN MÓVIL (FORZAR HORIZONTAL) */
        [data-testid="column"] {
        ...
        /* Ajuste para el desplegable de estado */
...
if st.session_state.seccion == "TRABAJOS":
    ...
    for i, r in items.iterrows():
        with st.container():
            ...
            # PARTE 2: Desplegable de estado (Ancho completo)
            ...
            # PARTE 3: Botones PDF y Ajustes (FORZADOS EN PARALELO)
            ...
            with c_ed:
                # El expander se cerrará solo al hacer el rerun tras el "Ok"
                with st.expander("⚙️"):
                    with st.form(f"f_ed_{r['ID']}"):
                        ...
                        if st.form_submit_button("Ok"):
                            ...
                            st.cache_data.clear()
                            st.rerun() # Esto refresca la página y cierra el expander automáticamente
...
# 7. VISTA: NUEVO TRABAJO (Calculadora preservada)
